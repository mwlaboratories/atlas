...
struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	...
	{(const void *)0x428dd, (ISR)0x51d4b}, /* 39 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 40 */
	{(const void *)0x46931, (ISR)0x51d4b}, /* 41 */
